            ...
            function(tx) {
                ...
                if (rs.rows.length > 0) {
                    ...
                    startModel.append({"segment": 0,
                                       "column": [{"cid": 0, cursor: 0, "title": "特 色", "image": "", "style": "IMAGE_RECT", "slotQml": "ItemsView.qml", "rectColor": "#de9317", "hotColor": "#d54d34"},
                                                  ...
                                                  {"cid": 2, cursor: 0, "title": "套 餐", "image": "", "style": "IMAGE_RECT", "slotQml": "ItemsView.qml", "rectColor": "#96b232", "hotColor": "#4eb3b9"}]});
                    startModel.append({"segment": 0,
                                       "column": [{"cid": 3, cursor: 0, "title": "优 惠", "image": "qrc:/images/skaner.png", "style": "ICON_RECT", "slotQml": "rect.qml", "rectColor": "#034888", "hotColor": "#d54d34"},
                                                  ...
                                                  {"cid": 5, cursor: 0, "title": "主 食", "image": "", "style": "IMAGE_RECT", "slotQml": "ItemsView.qml", "rectColor": "#96b232", "hotColor": "#6e155f"}]});
                    startModel.append({"segment": 0,
                                       "column": [{"cid": 6, cursor: 0, "title": "浓 汤", "image": "", "style": "IMAGE_RECT", "slotQml": "ItemsView.qml", "rectColor": "#d54d34", "hotColor": "#de9317"},
                                                  {"cid": 7, cursor: 0, "title": "小 食", "image": "", "style": "IMAGE_RECT", "slotQml": "ItemsView.qml", "rectColor": "#4eb3b9", "hotColor": "#96b232"},
                    ...
                    startModel.append({"segment": 1,
                                       "column": [{"cid": 9, cursor: 0, "title": "红 酒", "image": "", "style": "IMAGE_RECT", "slotQml": "ItemsView.qml", "rectColor": "#FF0097", "hotColor": "#d54d34"},
                                                  {"cid": 10, cursor: 0, "title": "甜 品", "image": "", "style": "IMAGE_RECT", "slotQml": "ItemsView.qml", "rectColor": "#6e155f", "hotColor": "#d54d34"},
                                                  {"cid": 11, cursor: 0, "title": "拼 盘", "image": "", "style": "IMAGE_RECT", "slotQml": "ItemsView.qml", "rectColor": "#96b232", "hotColor": "#4eb3b9"}]});
                    startModel.append({"segment": 1,
                                       "column": [{"cid": 12, cursor: 0, "title": "记 录", "image": "qrc:/images/tasks.png", "style": "ICON_RECT", "slotQml": "rect.qml", "rectColor": "#96b232", "hotColor": "#d54d34"},
                                                  {"cid": 13, cursor: 0, "title": "炒 饭", "image": "", "style": "IMAGE_RECT", "slotQml": "ItemsView.qml", "rectColor": "#034888", "hotColor": "#d54d34"},
                                                  {"cid": 14, cursor: 0, "title": "新 闻", "image": "qrc:/images/rss.png", "style": "ICON_RECT", "slotQml": "rect.qml", "rectColor": "#de9317", "hotColor": "#d54d34"}]});
                    startModel.append({"segment": 1,
                                       "column": [{"cid": 15, cursor: 0, "title": "食 谱", "image": "", "style": "IMAGE_RECT", "slotQml": "ItemsView.qml", "rectColor": "#1BA1E2", "hotColor": "#d54d34"},
                    ...
                    startModel.append({"segment": 2,
                                       "column": [{"cid": 18, cursor: 0, "title": "风 味", "image": "", "style": "IMAGE_RECT", "slotQml": "ItemsView.qml", "rectColor": "#d54d34", "hotColor": "#d54d34"},
                                                  {"cid": 19, cursor: 0, "title": "时 蔬", "image": "", "style": "IMAGE_RECT", "slotQml": "ItemsView.qml", "rectColor": "#de9317", "hotColor": "#d54d34"},
                                                  {"cid": 20, cursor: 0, "title": "煲 仔", "image": "", "style": "IMAGE_RECT", "slotQml": "ItemsView.qml", "rectColor": "#6e155f", "hotColor": "#4eb3b9"}]});
                    startModel.append({"segment": 2,
                                       "column": [{"cid": 21, cursor: 0, "title": "沙 拉", "image": "", "style": "IMAGE_RECT", "slotQml": "ItemsView.qml", "rectColor": "#5859b9", "hotColor": "#d54d34"},
                                                  {"cid": 22, cursor: 0, "title": "水 果", "image": "", "style": "IMAGE_RECT", "slotQml": "ItemsView.qml", "rectColor": "#034888", "hotColor": "#d54d34"},
